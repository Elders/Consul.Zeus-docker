...
RUN wget https://releases.hashicorp.com/consul/0.9.3/consul_0.9.3_linux_amd64.zip --no-check-certificate

RUN unzip consul_0.9.3_linux_amd64.zip -d /var/consul
