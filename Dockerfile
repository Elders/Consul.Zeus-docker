...
RUN wget https://releases.hashicorp.com/consul/0.8.4/consul_0.8.4_linux_amd64.zip --no-check-certificate

RUN unzip consul_0.8.4_linux_amd64.zip -d /var/consul
